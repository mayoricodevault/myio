        ...
        link: function($scope, el, attrs) {
            el.on('contextmenu', function(e) {
                ...
                $scope.$apply(function() {
                    ...
                    } else if (selectedItems.get() && !selectedItems.has($scope.item)) {
                        selectedItems.deselectAll();
        ...
        generateMenu: function(context) {
            ...
            for (var i = 0; i < items.length; i++) {
                ...
                if (item.action === 'favorite' && (selectedItems.getLength() === 1 && utils.hasLabel(selectedItems.first(), 'favorite') || utils.stateIs('dashboard.favorites'))) {
                    menu.append('<li class="context-menu-item" data-action="unfavorite"><i class="icon icon-'+item.icon+'"></i> Unfavorite</li>');
                    continue;
                }
